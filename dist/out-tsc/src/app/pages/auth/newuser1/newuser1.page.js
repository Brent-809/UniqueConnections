...
export let Newuser1Page = class Newuser1Page {
    updateBioLength() {
    ...
    saveBioAndAge() {
        ...
        if (userId) {
            this.apiService
                ...
                .subscribe((response) => {
                console.log("Update bio: ", response);
                if (response.id && response.bio === bio) {
                    console.log("User bio successfully updated!");
            ...
            this.apiService
                ...
                .subscribe((response) => {
                console.log("Update age: ", response);
                if (response.id && response.age === age) {
                    console.log("User age successfully updated!");
